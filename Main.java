...
//	private JTextField textField_2 = null;
	...
	private JLabel lblNewLabel = new JLabel("From");
	
	private JButton btnNewButton = new JButton(". . .");
	
	private JLabel lblNewLabel_1 = new JLabel("To");
	
	private JButton btnNewButton_1 = new JButton(". . .");
	
	private JButton btnNewButton_2 = new JButton("IN");
	
	private JButton btnNewButton_3 = new JButton("OUT");
	...
	private final JLabel lblNewLabel_3 = new JLabel("Status");
	
	public Main() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setSize(600,300);
		setTitle("LSB.Alisova 2014.");
